...
#define AD_ServiceHttp @"http://mobads.baidu.com/cpro/ui/mads.php"
...
- (void)loadAdData {
    ...
    [manager GET:AD_ServiceHttp parameters:parameters progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
